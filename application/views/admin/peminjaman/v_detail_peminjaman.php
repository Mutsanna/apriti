...
<table class="table">
  <tbody>
    ...
    <tr>
        <td colspan="2">
            <a href="<?php echo base_url().'c_mahasiswa/konfirmasi_peminjaman/'.$k->id_peminjaman.'/'.$k->id_ruangan; ?>"class="btn btn-outline-success btn-block">
                Konfirmasi
            </a>
            <a href="<?php echo base_url().'c_mahasiswa/batal_peminjaman/'.$k->id_peminjaman.'/'.$k->id_ruangan; ?>"class="btn btn-outline-danger btn-block">
                Batal Peminjaman
            </a>
        </td>
    </tr>
