    ...
    <div class="row">
                ...
                <div class="panel-body">
                    <div class="list-group list-group-flush">
                        <?php foreach($gedung as $k){ ?>
                            <a href="<?php echo base_url().'c_admin/ruangan/'.$k->id_gedung; ?>" class="list-group-item">
                ...
                <div class="panel-body">
                    <div class="list-group list-group-flush">
                        <?php foreach($ruangan_konfirmasi as $d){ ?>
                            <a href="<?php echo base_url().'c_admin/detail_peminjaman/'.$d->id_ruangan; ?>" class="list-group-item">
                                <i class="glyphicon glyphicon-user"></i> <?php echo $d->nama_ruangan; ?>
                            </a>				
                        <?php } ?>
                    </div>
                    <div class="text-right">
                        <a href="<?php echo base_url().'c_admin/gedung' ?>" class="btn btn-sm btn-block btn-outline-warning">Data ruangan yang minta konfirmasi &nbsp; <i class="fa fa-arrow-right"></i>&nbsp;</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-4">
            <div class="card ">
                ...
                <div class="panel-body">
                    <div class="list-group list-group-flush">
                        <?php foreach($ruanganii as $k){ ?>
                            <a href="#" class="list-group-item">
                                <i class="glyphicon glyphicon-user"></i> <?php echo $k->nama_ruangan; ?>
                            </a>				
                        <?php } ?>
                    </div>
                    <div class="text-right">
