<div class="container">
  <div class="card">
    ...
    <div class="card-body">
      ...
      <form method="post" action="<?php echo base_url().'c_admin/ruangan_tambah_aksi'; ?>">
      <fieldset disabled>
      <div class="form-group">
          <label class="font-weight-bold" for="disabledTextInput">Nama Gedung</label>
          <input type="text" id="disabledTextInput" class="form-control" name="gedung" placeholder="<?php echo $a->nama_gedung; ?>">
        </div>
        </fieldset>
        <div class="form-group">
          <label class="font-weight-bold" for="gedung">Nama Ruangan</label>
          <input type="hidden" value="<?php echo $a->id_gedung; ?>" name="idgedung">
          <input type="text" class="form-control" name="nama" placeholder="Masukkan Nama Ruangan" required="required">
        </div>
        <div class="form-group">
          <label class="font-weight-bold" for="gedung">Kapasitas</label>
          <input type="number" class="form-control" name="kapasitas" placeholder="Masukkan Kapasitas : Number Only" required="required">
        </div>
        <div class="form-group">
