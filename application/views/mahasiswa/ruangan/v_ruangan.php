<div class="container">
  <div class="card">
    ...
    <div class="card-body">
    <a href="<?php echo base_url().'c_mahasiswa/gedung_ruangan' ?>" class='btn btn-sm btn-outline-dark pull-left'><i class="fa fa-arrow-left"></i> Kembali</a>
      ...
      <table class="table table-bordered table-striped table-hover">
        ...
        foreach($ruangan as $p){
          ...
          <tr>
            ...
            <td>
              <a href="<?php echo base_url().'c_mahasiswa/pinjam/'.$p->id_ruangan.'/'.$a->id_gedung; ?>" class="btn btn-sm btn-block btn-outline-success"><i class="fa fa-key"></i> Pinjam</a>
